...
Revision ID: 46f5e757ae07
Revises: 
Create Date: 2017-05-18 13:35:02.122620
...
def upgrade():
    ...
    sa.Column('locationLatLong', sa.String(length=40), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_centrals_locationLatLong'), 'centrals', ['locationLatLong'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_centrals_locationLatLong'), table_name='centrals')
